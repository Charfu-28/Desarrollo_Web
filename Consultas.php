<html lang="es">
	...
	<body>
		...
		<div class="panel panel-primary">
			...
			<input type="submit" value="Productos 	- Precio" class="btn btn-link" name="btn5"><br>
			<input type="submit" value="Productos Vendidos" class="btn btn-link" name="btn6"><br><br>
		</div>
		</form>
		...
		if(isset($_POST['btn6']))
		{
			...
			$resultados = mysqli_query($conexion, "SELECT * FROM  Factura_Venta");
				echo "
					...
					<tr>
						<td><b><center>Nombre Producto</center></b></td>
						<td><b><center>Unidades Vendidas</center></b></td>						
					</tr>
					<table>
					</center>";					
			while ($consulta = mysqli_fetch_array($resultados))
			{
				echo "													
					<table width =\"30%\" border=\"1\">					
						<tr>					
							<td width=\"38%\" >".$consulta['Nombre_Producto']."</td>
							<td width=\"32%\">".$consulta['Cantidad']."</td>									
						</tr>
					</table>";
			}
